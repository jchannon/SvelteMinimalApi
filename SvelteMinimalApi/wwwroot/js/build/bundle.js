(function () {
    ...
    /* wwwroot/js/Form.svelte generated by Svelte v3.32.3 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Create a free account";
    			t1 = space();
    			form = element("form");
    			...
    			this.c = noop;
    			input0.value = /*tokenvalue*/ ctx[1];
    			attr(input0, "name", /*tokenfieldname*/ ctx[0]);
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*tokenvalue*/ 2) {
    				input0.value = /*tokenvalue*/ ctx[1];
    			}

    			if (dirty & /*tokenfieldname*/ 1) {
    				attr(input0, "name", /*tokenfieldname*/ ctx[0]);
    			}
    		},
    		i: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { tokenfieldname } = $$props;
    	let { tokenvalue } = $$props;

    	$$self.$$set = $$props => {
    		if ("tokenfieldname" in $$props) $$invalidate(0, tokenfieldname = $$props.tokenfieldname);
    		if ("tokenvalue" in $$props) $$invalidate(1, tokenvalue = $$props.tokenvalue);
    	};

    	return [tokenfieldname, tokenvalue];
    }
    ...
    class Form extends SvelteElement {
    	...
    	set tokenfieldname(tokenfieldname) {
    		this.$set({ tokenfieldname });
    		flush();
    	}
    ...
    customElements.define("svelte-form", Form);
